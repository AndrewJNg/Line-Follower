...
void loop() {
  ...
  if (Start) {
    if (Mode == 1) {
      ...
      Junction(150, 150, 0.5, 50, 'L', 'L');
      Buzz(1, 100);
      Junction(100, 100, 0.8, 50, 'L', 'L');
Stop();
delay(100);
      Buzz(1, 100);
      Junction(150, 150, 0.3, 20, 'R', 'R');
      Buzz(1, 100);
      Junction(150, 150, 0.3, 20, 'L', 'L');
      Buzz(1, 100);
      Junction(150, 150, 0.3, 20, 'R', 'R');
      Buzz(1, 100);
      //C4
...
delay(100);
      Buzz(1, 100);
      Junction(100, 100, 0.3, 20, 'R', 'R');
      Buzz(1, 100);
      Junction(100, 100, 0.3, 20, 'L', 'L');
      Buzz(1, 100);
      Junction(100, 100, 0.3, 20, 'R', 'R');
      Buzz(1, 100);
      //C4
