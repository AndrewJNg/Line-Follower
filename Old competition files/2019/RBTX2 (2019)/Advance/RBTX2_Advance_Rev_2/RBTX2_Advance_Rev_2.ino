...
void loop() {
  ...
  if (Start) {
    if (Mode == 1) {
      ...
      Junction(150, 150, 0.5, 20, 'M', 's');
      Junction(150, 150, 0.2, 20, 'M', 'c');
      Junction(150, 150, 0.2, 20, 'R', 'A');
      ...
      Junction(200, 200, 0.2, 20, 'R', 'r');
      Junction(200, 200, 0.2, 20, 'L', 'L');
      Junction(200, 200, 0.2, 20, 'L', 'L');
      Junction(200, 200, 0.2, 30, 'L', 'L');
      Junction(200, 200, 0.5, 20, 'L', 'L');
      
      
      Junction(255, 255, 0.2, 100, 'M', 'B');
     ...
     // delay(10000);*/
      ...
      Junction(150, 150, 0.5, 20, 'R', 'r');
      Junction(150, 150, 0.2, 20, 'M', 's');
     
     //C2
     
      Junction(150, 150, 0.2, 20, 'R', 'i');
      Junction(150, 150, 0.2, 20, 'M', 'L');
      Junction(150, 150, 0.2, 20, 'L', 'i');
      //C3
