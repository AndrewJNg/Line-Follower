...
void loop() {
  ...
  if (Start) {
    if (Mode == 1) {
      ...
      Junction(255, 255, 0.2, 20, 'M', 'A');
      Junction(255, 255, 0.2, 20, 'R', 'R');
      Junction(255, 255, 0.2, 30, 'R', 'R');
      ...
      Junction(150, 150, 0.2, 20, 'L', 'L');
      Junction(150, 150, 0.2, 30, 'L', 'L');
      Junction(150, 150, 0.5, 20, 'L', 'L');


      Junction(150, 150, 0.05, 10, 'M', 'c');
      Junction(100, 100, 0.5, 20, 'U', 'B');
