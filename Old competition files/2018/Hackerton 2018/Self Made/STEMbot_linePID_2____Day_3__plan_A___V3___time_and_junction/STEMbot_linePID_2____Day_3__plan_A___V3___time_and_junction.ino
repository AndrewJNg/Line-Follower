...
//  junction(speedL, speedR, kp  , kd  , type, action, action_delay, turn_speed, turn_time);
    ...
    junction(255   , 255   , 0.3 , 0.35, 'L' , 'l'   , 275         , 255       , 425);   //6
    digitalWrite(12,LOW);Stop();delay(0000000000000000000);
    junction(255   , 255   , 0.3 , 0.4, 'R' , 'r'   , 275         , 255       , 425);   //7
    digitalWrite(11,HIGH);Stop();delay(00);
    junction(255   , 255   , 0.25 , 0.4, 'M' , 'l'   , 275         , 255       , 425);   //8
    digitalWrite(13,HIGH);Stop();delay(00);
    junction(255   , 255   , 0.25 , 0.4, 'M' , 'r'   , 275         , 255       , 425);   //9
